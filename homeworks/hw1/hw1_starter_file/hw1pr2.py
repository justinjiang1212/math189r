...
if __name__ == '__main__':
  ...
  #use normal equation from prof gu's notes to find W_opt

	X_space_stacked_T_y = np.matmul(X_space_stacked_T, y_space_rand)#var for X^T * Y
	X_space_stacked_T_X = np.matmul(X_space_stacked_T,X_space_stacked )#var for X^T X
	W_opt = np.linalg.solve(X_space_stacked_T_X, X_space_stacked_T_y)
